...
// MFCProgressApplication.cpp : Определяет поведение классов для приложения.
//
...
// создание CMFCProgressApplicationApp

CMFCProgressApplicationApp::CMFCProgressApplicationApp()
{
	...
	SetAppID(_T("MFCProgressApplication.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMFCProgressApplicationApp

CMFCProgressApplicationApp theApp;


// инициализация CMFCProgressApplicationApp

BOOL CMFCProgressApplicationApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_MFCProgressApplTYPE,
		RUNTIME_CLASS(CMFCProgressApplicationDoc),
		RUNTIME_CLASS(CChildFrame), // настраиваемая дочерняя рамка MDI
		RUNTIME_CLASS(CMFCProgressApplicationView));
	if (!pDocTemplate)
		return FALSE;
...
int CMFCProgressApplicationApp::ExitInstance()
{
...
// обработчики сообщений CMFCProgressApplicationApp
...
void CMFCProgressApplicationApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
void CMFCProgressApplicationApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CMFCProgressApplicationApp::LoadCustomState()
{
}

void CMFCProgressApplicationApp::SaveCustomState()
{
}
