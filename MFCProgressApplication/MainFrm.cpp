...
//---------------------------------------------------------------
// Создание диалога в рабочем потоке и запуск вычислений в потоке данных
...
// Метод запускающий ф-цию рассчета в новом потоке данных
...
// Дополнительный метод в рабочем потоке
